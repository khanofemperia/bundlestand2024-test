    ...
    <>
      <div className="mt-11">
        ...
        <div className="w-[1014px] mx-auto mb-52 pt-10">
          ...
          <div id="shop-now" className="mt-16">
            <div className="w-full mb-5 px-[10px] flex items-center gap-2">
            ...
            <div className="w-full flex flex-wrap">
              {Array.from({ length: 9 }, (_, index) => (
                <div
                  key={index}
                  className="w-[338px] p-[10px] rounded-2xl relative ease-in-out hover:ease-out hover:duration-300 hover:before:content-[''] hover:before:absolute hover:before:top-0 hover:before:bottom-0 hover:before:left-0 hover:before:right-0 hover:before:rounded-2xl hover:before:shadow-custom3"
                >
                  <div className="w-full h-[338px] bg-gray2 rounded-xl flex items-center justify-center overflow-hidden">
                    <img
                      src="https://i.pinimg.com/564x/c9/90/01/c99001f23cc97cb2be4c2fcc771c4fad.jpg"
                      alt=""
                      width={338}
                    />
                  </div>
                  <div>
                    ...
                    <div className="flex items-center justify-between w-full mt-[6px]">
                      <div className="flex items-center gap-2 w-max h-5">
                        <p className="[font-family:'Segoe_UI'] text-[22px] font-bold text-black">
                          $6.23
                        </p>
                        <p className="[font-family:'Segoe_UI'] mt-[3px] text-sm line-through text-gray">
                          $10.99
                        </p>
                      </div>
                      <button className="before:content-[''] before:absolute before:top-0 before:bottom-0 before:left-0 before:right-0 before:border before:border-black before:rounded-full hover:before:scale-105 relative outline-none border-none rounded-full w-[50px] h-8 flex items-center justify-center">
                        <img
                          src="/cart_plus.svg"
                          alt="Add to cart"
                          width={25}

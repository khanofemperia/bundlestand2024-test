...
type ArticlesTableProps = { articles: ArticleProps[] };
            ...
            <table className="border-collapse">
              <thead>
                <tr className="bg-gray2 flex">
                  ...
                  <th className="w-[90px] h-9 flex items-center pl-[6px] border-r">
                    <h3 className="heading-size-h3 whitespace-nowrap text-gray">
                      Poster
                    </h3>
                  </th>
              ...
              <tbody>
                {tableData.length === 0 ? (
                  ...
                  tableData.map(
                    (
                      { id, poster, title, status, visibility, slug },
                      index
                    ) => {
                      ...
                      return (
                        <tr key={id} className={rowClasses}>
                          <th className="w-[50px] flex items-center relative pr-2 border-r">
                            <button
                              onClick={() => copyToClipboard(id)}
                              className="w-8 h-8 absolute right-1 rounded-full grid place-items-center ease-in-out hover:bg-gray2 hover:duration-300 hover:ease-out"
                            >
                              <TbCopy className="stroke-[#767676]" size={20} />
                            </button>
                          </th>
                          <td className="w-[90px] border-r p-2">
                            <div className="w-full h-full bg-gray2">
                              {poster && (
                                <Image
                                  src={poster}
                                  alt={title}

...
export function WriteArticleButton() {
  ...
  const { pageName, overlayName } = useOverlayStore((state) => ({
    ...
    overlayName: state.pages.editArticle.overlays.content.name,
  }));
  ...
  return (
    <button
      ...
      onClick={openOverlay}
    >
      Write or improve the article's main text
    </button>
  );
}
...
export function WriteArticle({
  ...
  const { pageName, isOverlayVisible, overlayName } = useOverlayStore(
    (state) => ({
      pageName: state.pages.editArticle.name,
      overlayName: state.pages.editArticle.overlays.content.name,
      isOverlayVisible: state.pages.editArticle.overlays.content.isVisible,
    })
  );
